function initAdminAccountRequestList() {
  ...
  function formatDateTime(timestamp) {
    ...
    return date.toLocaleDateString("en-IN") + '<br><span style="font-size: 12px; color: #666;">' + date.toLocaleTimeString("en-IN", { hour: '2-digit', minute: '2-digit', hour12: true }) + '</span>';
  }
